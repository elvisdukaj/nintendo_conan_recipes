...
class SDLConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.settings.os == "NintendoWii":
            self.requires("opengx/0.15.0", transitive_headers=True)
            self.requires("libogc/2.10.0", transitive_headers=True)
            self.requires("libdvm/2.0.0")
    ...
    def package_info(self):
        ...
        elif self.settings.os == "NintendoWii":
                self.cpp_info.components["libsdl2"].requires.append("libogc::ogc")
                self.cpp_info.components["libsdl2"].requires.append("libogc::sound")
                self.cpp_info.components["libsdl2"].requires.append("libogc::wiikeyboard")
                self.cpp_info.components["libsdl2"].requires.append("libdvm::libdvm")
                self.cpp_info.components["libsdl2"].requires.append("opengx::opengx")
